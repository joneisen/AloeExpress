...
Protected Module DemoHelloWorld
	...
	#tag Method, Flags = &h0
		Sub RequestProcess(Request As AloeExpress.Request)
		  ...
		  Request.StaticPath = GetFolderItem("").Parent.Child("htdocs").Child("demo-hello-world")
		  ...
		  If Request.Path = "/hello" Then
		    ...
		    Dim Now As String = AloeExpress.DateToRFC1123
		    ...
		    + "<p style=""text-align: center; font-size: 14pt;"">This is a demo of Aloe Express " + AloeExpress.VersionString + ".</p>" _
